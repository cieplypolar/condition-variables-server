 ...
 *   0x1700 - 0x17FF    CVS syscalls and communication with other servers
 *
 ...
 *===========================================================================*/
#define CVS "cvs"
#define CVS_BASE 0x1700
#define CVS_LOCK CVS_BASE 
#define CVS_UNLOCK CVS_BASE + 1 
#define CVS_WAIT CVS_BASE + 2
#define CVS_BROADCAST CVS_BASE + 3
/* CVS uses msg type 1 */
#define CVS_MUTEX_ID m1_i1
#define CVS_CV_ID m1_i2
/* register in PM */
#define I_AM_CVS_BETTER_REMEMBER_ME_PM CVS_BASE + 4
#define BYE_PM CVS_BASE + 5
...
#  define SYS_STOP_PROC  (KERNEL_CALL + 57) /* sys_stop_proc()    */
#  define SYS_RESUME_PROC (KERNEL_CALL + 58) /* sys_resume_proc() */
/* Total */
